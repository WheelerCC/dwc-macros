; locate-front-face.g — find front face of workpiece
...
while iterations < var.fineProbeCount
    ...
    G90                                 ; back to absolute mode
    set var.probedSum = var.probedSum + move.axes[1].machinePosition
    G91                                 ; relative mode
    G0 Y-0.7                            ; retract between fine probes
    G90                                 ; back to absolute mode
